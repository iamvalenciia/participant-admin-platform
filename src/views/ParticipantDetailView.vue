    ...
    >
      ...
      <div class="p-6">
        ...
        <div v-else class="grid grid-cols-1 gap-5 sm:grid-cols-2">
          <div>
            <div class="text-sm font-medium text-teal-700 dark:text-amber-200">
          ...
          <div class="sm:col-span-2">
            <div
              ...
              class="p-3 bg-amber-100/50 dark:bg-teal-900/50 rounded-md border border-amber-200 dark:border-teal-800"
            >
            ...
            >
              ...
              <div
                class="grid grid-cols-3 divide-x divide-amber-200 dark:divide-teal-800"
              >
                <div class="p-3">
                  <div
